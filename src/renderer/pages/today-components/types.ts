...
export type PromptType = 'weekly-priorities' | 'sprint-goal' | 'weekly-reflection' | 'skip-level-prep' | 'quarterly-okr' | 'team-health-check' | 'sprint-retro' | 'personal-retro' | 'hiring-review' | 'one-on-one-format-check'
