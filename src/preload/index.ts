...
contextBridge.exposeInMainWorld('api', {
  ...
  createPerson: (displayName: string, fields?: { role?: string; github?: string; location?: string; relationship?: string; aliases?: string[] }) => ipcRenderer.invoke('github:create-person', displayName, fields),
  ...
  getPersonActionItems: (slug: string) => ipcRenderer.invoke('github:person-action-items', slug),
  ...
  fetchTeamMemberActivity: (reportName: string) =>
    ipcRenderer.invoke('github:fetch-team-member-activity', reportName),
